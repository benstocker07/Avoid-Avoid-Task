...
class SurveyApp:
    ...
    def show_intro(self):
        ...
        intro_text = "You will first be asked various questions about your beliefs and attitudes towards various topics.\n\n\nPlease read the questions carefully but do not overthink the content of the question.\n\n\n\n\n\nClick anywhere to continue."
    ...
    def key_pressed(self, event):
        if event.char in ['1','2','3','4','5']:
            ...
            with open("Backup/STAI.csv", mode="a+", newline="") as file:
